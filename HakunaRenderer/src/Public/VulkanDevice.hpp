...
typedef struct _VulkanDevice
{
	...
	*/
	_VulkanDevice(VkPhysicalDevice physicalDevice)
	{
	...
	*/
	...
	{
		VkCommandBufferAllocateInfo cmdBufAllocateInfo = VKInitializers::commandBufferAllocateInfo(commandPool, level, 1);
